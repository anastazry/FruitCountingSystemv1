...
<head>
  ...
  <style type="text/css">
    ...
    html {
    font-size: 120%; /* Increases the base font size by 20% */
    }

    body {
        zoom: 1.2; /* Scale the entire body by 120% */
    }

      /* Ensure all components scale responsively */
  html {
    font-size: 16px;
  }
  ...
  @media (max-width: 480px) {
    html {
      font-size: 12px; /* Further adjust for very small devices */
    }
...
<body class="bg-gray-50 dark:bg-neutral-900">
  ...
  <div id="hs-application-sidebar" class="hs-overlay  [--auto-close:lg]
    ...
    <div class="relative flex flex-col h-full max-h-full">
      <div class="px-12 pt-4" style="padding-left: 23%">
        <!-- Logo -->
        <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="#" aria-label="Preline" style="padding-left: 5%">
          <img class="w-28 h-auto" src="{{ asset('images/icons/FELDA_logo.png') }}" alt="Icon">
        ...
        <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
          <ul class="flex flex-col space-y-1">
            ...
            <li>
              ...
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-orange-600 text-sm text-white rounded-lg hover:bg-orange-200 hover:text-gray-800 focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="{{route('dashboard')}}">
                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
                @if(isset($page) && $page == "assignment-list")
                    <a class="bg-orange-500 w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-300" href="{{route('admin.assign-list')}}">
                        <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
                @if(isset($page) && $page == "new-user")
              <a class="bg-orange-600 w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-300" href="{{route('admin-users-registration-form')}}">
                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
                  <circle cx="9" cy="7" r="4" />
                  <path d="M22 21v-2a4 4 0 0 0-3-3.87" />
            ...
            <li>
                @if(isset($page) && $page == "view-report")
                    <a class="bg-orange-600 w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-white rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-300" href="{{route('user-view-report')}}">
                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" />
                            <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" />
                            </svg>
                ...
                @else
                <a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-900 dark:text-neutral-200 dark:hover:text-neutral-300" href="{{route('user-view-report')}}">
                            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" />
                            <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" />
                            </svg>
            ...
            <li>
                @if(isset($page) && $page == "Dashboard")
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-orange-600 text-sm text-white rounded-lg hover:bg-orange-100 focus:outline-none focus:bg-gray-100 dark:bg-neutral-700 dark:text-white" href="{{route('dashboard')}}">
                <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
                  <polyline points="9 22 9 12 15 12 15 22" />
                </svg>
  ...
  <!-- Content -->
  <div class="bg-orange-500 w-full lg:ps-64">
    <div class="bg-orange-500 p-4 sm:p-6 space-y-4 sm:space-y-6 h-full">
      <!-- Grid -->
      ...
      buildChart(
        ...
        (mode) => ({
          ...
          series: [
            {
              name: "MUDA",
              data: [32000, 41000, 38000, 15800, 0, 0, 0, 0, 0, 0, 0, 0],
            },
            {
              name: "BUSUK",
              data: [24000, 28500, 26200, 27450, 0, 0, 0, 0, 0, 0, 0, 0],
            },
            {
              name: "PANJANG",
              data: [36000, 42000, 39500, 41670, 0, 0, 0, 0, 0, 0, 0, 0],
            },
            {
              name: "KOSONG",
              data: [27000, 30000, 28500, 28910, 0, 0, 0, 0, 0, 0, 0, 0],
            },
          ],
          plotOptions: {
            bar: {
        ...
        buildChart(
          ...
          (mode) => ({
            ...
            series: [
              {
                name: "JUMLAH MUDA",
                data: [312540, 287430, 401250, 198760, 356820, 423190, 275640],
              },
              {
                name: "JUMLAH BUSUK",
                data: [198430, 334210, 256780, 412300, 187650, 298740, 365120],
              },
              {
                name: "JUMLAH PANJANG",
                data: [287650, 412300, 198760, 356820, 423190, 312540, 275640],
              },
              {
                name: "JUMLAH KOSONG",
                data: [356820, 198760, 423190, 275640, 312540, 287430, 401250],
              },
            ],
            legend: {
              show: false,
